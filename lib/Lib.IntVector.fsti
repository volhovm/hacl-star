...
type vec_index (w:width) = n:size_t{v n < w}
...
inline_for_extraction noextract
val create2: #a:Type -> x0:a -> x1:a -> s:lseq a 2{
	     s.[0] == x0 /\ 
	     s.[1] == x1}
inline_for_extraction noextract
val create4: #a:Type -> x0:a -> x1:a -> x2:a -> x3:a -> s:lseq a 4{
	     s.[0] == x0 /\ 
	     s.[1] == x1 /\ 
	     s.[2] == x2 /\ 
	     s.[3] == x3}
...
inline_for_extraction noextract
val create8: #a:Type -> x0:a -> x1:a -> x2:a -> x3:a -> x4:a -> x5:a -> x6:a -> x7:a -> s:lseq a 8{
	     s.[0] == x0 /\ 
	     s.[1] == x1 /\ 
	     s.[2] == x2 /\ 
	     s.[3] == x3 /\ 
...
inline_for_extraction noextract
val create16: #a:Type -> x0:a -> x1:a -> x2:a -> x3:a -> x4:a -> x5:a -> x6:a -> x7:a -> x8:a -> x9:a -> x10:a -> x11:a -> x12:a -> x13:a -> x14:a -> x15:a -> s:lseq a 16{
	     s.[0] == x0 /\ 
	     s.[1] == x1 /\ 
	     s.[2] == x2 /\ 
	     s.[3] == x3 /\ 
...
inline_for_extraction noextract
val create32: #a:Type -> x0:a -> x1:a -> x2:a -> x3:a -> x4:a -> x5:a -> x6:a -> x7:a -> x8:a -> x9:a -> x10:a -> x11:a -> x12:a -> x13:a -> x14:a -> x15:a -> x16:a -> x17:a -> x18:a -> x19:a -> x20:a -> x21:a -> x22:a -> x23:a -> x24:a -> x25:a -> x26:a -> x27:a -> x28:a -> x29:a -> x30:a -> x31:a -> s:lseq a 32{
	     s.[0] == x0 /\ 
	     s.[1] == x1 /\ s.[2] == x2 /\ s.[3] == x3 /\ s.[4] == x4 /\ s.[5] == x5 /\ s.[6] == x6 /\ s.[7] == x7 /\ s.[8] == x8 /\ s.[9] == x9 /\ s.[10] == x10 /\ s.[11] == x11 /\ s.[12] == x12 /\ s.[13] == x13 /\ s.[14] == x14 /\ s.[15] == x15 /\ s.[16] == x16 /\ s.[17] == x17 /\ s.[18] == x18 /\ s.[19] == x19 /\ s.[20] == x20 /\ s.[21] == x21 /\ s.[22] == x22 /\ s.[23] == x23 /\ s.[24] == x24 /\ s.[25] == x25 /\ s.[26] == x26 /\ s.[27] == x27 /\ s.[28] == x28 /\ s.[29] == x29 /\ s.[30] == x30 /\ s.[31] == x31}

inline_for_extraction noextract
val vec_load: #t:v_inttype -> i:uint_t t SEC -> w:width -> v:vec_t t w{vec_v v == create w i}
inline_for_extraction noextract
val vec_load2: #t:v_inttype -> i0:uint_t t SEC -> i1:uint_t t SEC -> v:vec_t t 2{vec_v v == create2 i0 i1}
inline_for_extraction noextract
val vec_load4: #t:v_inttype -> i0:uint_t t SEC -> i1:uint_t t SEC  -> i2:uint_t t SEC -> i3:uint_t t SEC -> v:vec_t t 4{vec_v v == create4 i0 i1 i2 i3}
inline_for_extraction noextract
val vec_load8: #t:v_inttype -> i0:uint_t t SEC -> i1:uint_t t SEC  -> i2:uint_t t SEC -> i3:uint_t t SEC -> i4:uint_t t SEC -> i5:uint_t t SEC  -> i6:uint_t t SEC -> i7:uint_t t SEC -> v:vec_t t 8{vec_v v == create8 i0 i1 i2 i3 i4 i5 i6 i7}
inline_for_extraction noextract
val vec_load16: #t:v_inttype -> i0:uint_t t SEC -> i1:uint_t t SEC  -> i2:uint_t t SEC -> i3:uint_t t SEC -> i4:uint_t t SEC -> i5:uint_t t SEC -> i6:uint_t t SEC -> i7:uint_t t SEC  -> i8:uint_t t SEC -> i9:uint_t t SEC  -> i10:uint_t t SEC -> i11:uint_t t SEC -> i12:uint_t t SEC -> i13:uint_t t SEC  -> i14:uint_t t SEC -> i15:uint_t t SEC -> v:vec_t t 16{vec_v v == create16 i0 i1 i2 i3 i4 i5 i6 i7 i8 i9 i10 i11 i12 i13 i14 i15}
inline_for_extraction noextract
...
inline_for_extraction noextract
val vec_shift_right: #t:v_inttype -> #w:width -> v1:vec_t t w -> s:shiftval t{t <> U128 \/ uint_v s % 8 == 0} -> v2:vec_t t w{vec_v v2 == map (shift_right_i s) (vec_v v1)}
inline_for_extraction noextract
val vec_shift_left: #t:v_inttype -> #w:width -> v1:vec_t t w -> s:shiftval t{t <> U128 \/ uint_v s % 8 == 0} -> v2:vec_t t w{vec_v v2 == map (shift_left_i s) (vec_v v1)}
inline_for_extraction noextract
val vec_rotate_right: #t:v_inttype -> #w:width -> v1:vec_t t w -> s:rotval t{t <> U128 \/ uint_v s % 8 == 0} -> v2:vec_t t w{vec_v v2 == map (rotate_right_i s) (vec_v v1)}
inline_for_extraction noextract
val vec_rotate_left: #t:v_inttype -> #w:width -> v1:vec_t t w -> s:rotval t{t <> U128 \/ uint_v s % 8 == 0} -> v2:vec_t t w{vec_v v2 == map (rotate_left_i s) (vec_v v1)}
inline_for_extraction noextract
...
inline_for_extraction noextract
val vec_permute2: #t:v_inttype -> v1:vec_t t 2 -> i1:vec_index 2 -> i2:vec_index 2 -> v2:vec_t t 2{vec_v v2 == create2 (vec_v v1).[v i1] (vec_v v1).[v i2]}
inline_for_extraction noextract
val vec_permute4: #t:v_inttype -> v1:vec_t t 4 -> i1:vec_index 4 -> i2:vec_index 4 -> i3:vec_index 4 -> i4:vec_index 4 -> v2:vec_t t 4{vec_v v2 == create4 (vec_v v1).[v i1] (vec_v v1).[v i2] (vec_v v1).[v i3] (vec_v v1).[v i4]}
inline_for_extraction noextract
val vec_permute8: #t:v_inttype -> v1:vec_t t 8 -> i1:vec_index 8 -> i2:vec_index 8 -> i3:vec_index 8 -> i4:vec_index 8 -> i5:vec_index 8 -> i6:vec_index 8 -> i7:vec_index 8 -> i8:vec_index 8 -> v2:vec_t t 8{vec_v v2 == create8 (vec_v v1).[v i1] (vec_v v1).[v i2] (vec_v v1).[v i3] (vec_v v1).[v i4] (vec_v v1).[v i5] (vec_v v1).[v i6] (vec_v v1).[v i7] (vec_v v1).[v i8]}
inline_for_extraction noextract
val vec_permute16: #t:v_inttype -> v1:vec_t t 16 -> i1:vec_index 16 -> i2:vec_index 16 -> i3:vec_index 16 -> i4:vec_index 16 -> i5:vec_index 16 -> i6:vec_index 16 -> i7:vec_index 16 -> i8:vec_index 16 -> i9:vec_index 16 -> i10:vec_index 16 -> i11:vec_index 16 -> i12:vec_index 16 -> i13:vec_index 16 -> i14:vec_index 16 -> i15:vec_index 16 -> i16:vec_index 16 -> v2:vec_t t 16{let vv1 = vec_v v1 in vec_v v2 == create16 vv1.[v i1] vv1.[v i2] vv1.[v i3] vv1.[v i4] vv1.[v i5] vv1.[v i6] vv1.[v i7] vv1.[v i8] vv1.[v i9] vv1.[v i10] vv1.[v i11] vv1.[v i12] vv1.[v i13] vv1.[v i14] vv1.[v i15] vv1.[v i16]}
inline_for_extraction noextract
...
// JP: waiting for AES specs to land
(* inline_for_extraction noextract *)

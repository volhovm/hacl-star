...
let carry_wide_step s i =
    ...
    let l = Hacl.UInt115.split51_low si in
    let h = Hacl.UInt115.split51_high si in
    let s' = Seq.upd s i (Hacl.UInt115.uint64_to_uint115 l) in
    let s'' = Seq.upd s' (i+1) (sip1 +^ (Hacl.UInt115.uint64_to_uint115 h)) in
    s''

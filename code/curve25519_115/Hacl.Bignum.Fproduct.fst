...
let carry_wide_ tmp =
  ...
  = let h = ST.get() in
    ...
    let r0 = Hacl.UInt115.split51_low tctr in
    let c  = Hacl.UInt115.uint64_to_uint115 (Hacl.UInt115.split51_high tctr) in
    // let c  = Hacl.UInt115.split51_high_full tctr in

...
#include "kremlib.h"
#ifndef __Curve25519_115_H
#define __Curve25519_115_H


#include "FStar.h"
#include "testlib.h"

typedef uint64_t Hacl_UInt115_uint64_t;
...
typedef Hacl_UInt115_t Hacl_Bignum_Constants_wide;

typedef uint64_t Hacl_Bignum_Parameters_limb;

typedef Hacl_UInt115_t Hacl_Bignum_Parameters_wide;

typedef uint32_t Hacl_Bignum_Parameters_ctr;

typedef uint64_t *Hacl_Bignum_Parameters_felem;

typedef Hacl_UInt115_t *Hacl_Bignum_Parameters_felem_wide;
...
typedef Hacl_UInt115_t Hacl_Bignum_Wide_t;
...
typedef uint8_t *Curve25519_115_uint8_p;

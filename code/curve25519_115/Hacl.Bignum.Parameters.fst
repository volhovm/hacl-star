...
inline_for_extraction let w x = Hacl.UInt115.v x
...
inline_for_extraction let wide_zero = Hacl.UInt115.uint64_to_uint115 (uint64_to_sint64 0uL)
inline_for_extraction let wide_one  = Hacl.UInt115.uint64_to_uint115 (uint64_to_sint64 1uL)

(* Addition primitives *)
inline_for_extraction let wide_add a b = Hacl.UInt115.add a b
// inline_for_extraction let wide_add_mod a b = Hacl.UInt115.add_mod a b
// (* Subtraction primitives *)
// inline_for_extraction let wide_sub a b = Hacl.UInt115.sub a b
// inline_for_extraction let wide_sub_mod a b = Hacl.UInt115.sub_mod a b

(* Bitwise operators *)
inline_for_extraction let wide_logand a b = Hacl.UInt115.logand a b
inline_for_extraction let wide_logxor a b = Hacl.UInt115.logxor a b
inline_for_extraction let wide_logor  a b = Hacl.UInt115.logor  a b
inline_for_extraction let wide_lognot a   = Hacl.UInt115.lognot a

// (* Shift operators *)
// inline_for_extraction let wide_shift_right a s = Hacl.UInt115.shift_right a s
// inline_for_extraction let wide_shift_left  a s = Hacl.UInt115.shift_left a s

// inline_for_extraction let wide_eq_mask a b  = Hacl.UInt115.eq_mask a b
// inline_for_extraction let wide_gte_mask a b = Hacl.UInt115.gte_mask a b
// inline_for_extraction let wide_gt_mask a b  = Hacl.UInt115.gt_mask a b
// inline_for_extraction let wide_lt_mask a b  = Hacl.UInt115.lt_mask a b
// inline_for_extraction let wide_lte_mask a b = Hacl.UInt115.lte_mask a b

inline_for_extraction let mul_wide x y = Hacl.UInt115.mul_wide x y

inline_for_extraction let limb_to_wide x = Hacl.UInt115.uint64_to_uint115 x
inline_for_extraction let wide_to_limb x = Hacl.UInt115.uint115_to_uint64 x

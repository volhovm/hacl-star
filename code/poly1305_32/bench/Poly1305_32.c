...
Hacl_Bignum_Fproduct_sum_scalar_multiplication_(uint64_t *output, uint32_t *input, uint32_t s)
{
  for (uint32_t i = (uint32_t )0; i < (uint32_t )5; i = i + (uint32_t )1)
  {
    uint64_t uu____871 = output[i];
    uint32_t uu____874 = input[i];
...
Hacl_Bignum_AddAndMultiply_add_and_multiply(uint32_t *acc, uint32_t *block, uint32_t *r)
{
  for (uint32_t i = (uint32_t )0; i < (uint32_t )5; i = i + (uint32_t )1)
  {
    uint32_t uu____871 = acc[i];
    uint32_t uu____874 = block[i];
...
)
{
  ...
  uint32_t
  r1 =
    (uint32_t )FStar_Int_Cast_Full_uint128_to_uint64(FStar_UInt128_shift_right(k_clamped,
        (uint32_t )26))
    & (uint32_t )0x3ffffff;
  uint32_t
  r2 =
...
)
{
  ...
  FStar_UInt128_uint128
  acc_ =
    FStar_UInt128_logor(FStar_UInt128_shift_left(FStar_Int_Cast_Full_uint64_to_uint128((uint64_t )h4),
        (uint32_t )104),
      FStar_UInt128_logor(FStar_UInt128_shift_left(FStar_Int_Cast_Full_uint64_to_uint128((uint64_t )h3),
          (uint32_t )78),
        FStar_UInt128_logor(FStar_UInt128_shift_left(FStar_Int_Cast_Full_uint64_to_uint128((uint64_t )h2),
            (uint32_t )52),
          FStar_UInt128_logor(FStar_UInt128_shift_left(FStar_Int_Cast_Full_uint64_to_uint128((uint64_t )h1),
              (uint32_t )26),
            FStar_Int_Cast_Full_uint64_to_uint128((uint64_t )h0)))));
...
void Poly1305_32_init(Hacl_Impl_Poly1305_32_State_poly1305_state st, uint8_t *k1)
{
  ...
  uint32_t *r = scrut.r;
  uint32_t *x0 = r;
  FStar_UInt128_uint128 k10 = load128_le(k1);
  FStar_UInt128_uint128
  k_clamped =
...
Poly1305_32_update(Hacl_Impl_Poly1305_32_State_poly1305_state st, uint8_t *m, uint32_t len1)
{
  ...
  else
  {
    ...
    Poly1305_32_update_block(st, block);
    Poly1305_32_update(st, m_, len2);
  }
}
...
Poly1305_32_finish(Hacl_Impl_Poly1305_32_State_poly1305_state st, uint8_t *mac, uint8_t *k1)
{
  ...
  uint32_t *h = scrut.h;
  uint32_t *acc = h;
  FStar_UInt128_uint128 k_ = load128_le(k1);
  uint32_t h0 = acc[0];
  uint32_t h1 = acc[1];
  uint32_t h2 = acc[2];
  uint32_t h3 = acc[3];

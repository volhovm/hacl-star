...
let smallfelem_neg out small tempBuffer =
	...
	let zero0  = tempBuffer.(size 0) in
...
zero105_2 tempBuffer;
  ...
  let input3 = input.(size 3) in
	let out0 = index out (size 0) in 
	let out1 = index out (size 1) in 
	let out2 = index out (size 2) in 
	let out3 = index out (size 3) in 
  let zero0  = tempBuffer.(size 0) in
  let zero1  = tempBuffer.(size 1) in
  let zero2  = tempBuffer.(size 2) in 
  let zero3  = tempBuffer.(size 3) in
...
let longfelem_diff out input =
  ...
  out.(size 2) <- sub out2 input2;
  out.(size 3) <- sub out3 input3;
  out.(size 4) <- sub out4 input4;
  out.(size 5) <- sub out5 input5;
  out.(size 6) <- sub out6 input6;
  out.(size 7) <- sub out7 input7

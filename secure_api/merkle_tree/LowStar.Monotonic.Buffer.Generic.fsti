...
type index_t (#n:nat) = FStar.UInt.uint_t n
type size_t (#n:nat) = index_t #n
 ...
 *)
val mbuffer (#n:nat) (a:Type0) (rrel rel:srel a) :Tot Type0
...
val g_is_null (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) :GTot bool

val mnull (#n:nat) (#a:Type0) (#rrel #rel:srel a) :Tot (b:mbuffer #n a rrel rel {g_is_null b})

val null_unique (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer a rrel rel) :Lemma (g_is_null #n b <==> b == mnull #n)

/// ``unused_in b h`` holds only if buffer ``b`` has not been allocated
/// yet.

val unused_in (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) (h:HS.mem) :GTot Type0
...
val live (#n:nat) (#a:Type0) (#rrel #rel:srel a) (h:HS.mem) (b:mbuffer #n a rrel rel) :GTot Type0


/// The null pointer is always live.

val live_null (#n:nat) (a:Type0) (rrel rel:srel a) (h:HS.mem) :Lemma (live h (mnull #n #a #rrel #rel))

let live_is_null (#n:nat) (#a:Type0) (#rrel #rel:srel a) (h:HS.mem) (b:mbuffer #n a rrel rel)
...
val live_not_unused_in (#n:nat) (#a:Type0) (#rrel #rel:srel a) (h:HS.mem) (b:mbuffer #n a rrel rel)
...
val lemma_live_equal_mem_domains (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) (h0 h1:HS.mem)
...
let live_not_unused_in' (#n:nat) (#a:Type0) (#rrel #rel:srel a) (h:HS.mem) (b:mbuffer #n a rrel rel)
...
val frameOf (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) :Tot HS.rid
...
val as_addr (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) :GTot nat


/// A buffer is unused if, and only if, its address is unused.

val unused_in_equiv (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) (h:HS.mem)
  :Lemma (unused_in b h <==>
...
val live_region_frameOf (#n:nat) (#a:Type0) (#rrel #rel:srel a) (h:HS.mem) (b:mbuffer #n a rrel rel)
...
val len (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) :GTot (size_t #n)

let length (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) :GTot nat = len #n b


/// The null pointer has length 0.

val len_null (#n:nat) (a:Type0) (rrel rel:srel a) :Lemma (len (mnull #n #a #rrel #rel) == UInt.zero n)

let length_null_1 (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel)
  :Lemma (requires (length b =!= 0)) (ensures (g_is_null b == false))
         [SMTPat (length b)]
  = len_null #n a rrel rel;
    null_unique b

let length_null_2 (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel)
...
val as_seq (#n:nat) (#a:Type0) (#rrel #rel:srel a) (h:HS.mem) (b:mbuffer #n a rrel rel) :GTot (Seq.seq a)


/// The contents of a buffer ``b`` has the same length as ``b`` itself.

val length_as_seq (#n:nat) (#a:Type0) (#rrel #rel:srel a) (h:HS.mem) (b:mbuffer #n a rrel rel)
...
let get (#n:nat) (#a:Type0) (#rrel #rel:srel a) (h:HS.mem) (p:mbuffer #n a rrel rel) (i:nat)
...
unfold let compatible_sub
  ...
  (b:mbuffer #n a rrel rel) (i:index_t #n) (len:size_t #n{i + len <= length b}) (sub_rel:srel a)
  = (forall (s1 s2:Seq.seq a).{:pattern (rel s1 s2);
                                   (sub_rel (Seq.slice s1 i (i + len))
			                    (Seq.slice s2 i (i + len)))}  //for any two sequences s1 and s2
                         (Seq.length s1 == length b /\ Seq.length s2 == length b /\ rel s1 s2) ==>  //that have lengths same as b, and are related by the preorder rel
		         (sub_rel (Seq.slice s1 i (i + len))
			          (Seq.slice s2 i (i + len)))) /\  //their slices [i, i + len) should be related by the preorder sub_rel,
    (forall (s s2:Seq.seq a).{:pattern (sub_rel (Seq.slice s ( i) ( i +  len)) s2);
                                  (rel s (Seq.replace_subseq s ( i) ( i +  len) s2))} //for any two sequences s and s2
                        (Seq.length s == length b /\ Seq.length s2 ==  len /\  //such that s has length same as b and s2 has length len
                         sub_rel (Seq.slice s ( i) ( i +  len)) s2) ==>  //and the slice [i, i + len) of s is related to s2 by sub_rel,
  		        (rel s (Seq.replace_subseq s ( i) ( i +  len) s2)))  //if we replace the slice [i, i + len) in s by s2, then s and the resulting buffer should be related by rel
...
val mgsub (#n:nat) (#a:Type0) (#rrel #rel:srel a) (sub_rel:srel a)
  (b:mbuffer #n a rrel rel) (i:index_t #n) (len:size_t #n)
  :Ghost (mbuffer #n a rrel sub_rel)
         (requires ( i +  len <= length b /\ compatible_sub b i len sub_rel))
	 (ensures (fun _ -> True))
...
val live_gsub (#n:nat) (#a:Type0) (#rrel #rel:srel a)
  (h:HS.mem) (b:mbuffer #n a rrel rel) (i:index_t #n) (len:size_t #n) (sub_rel:srel a)
  :Lemma (requires ( i +  len <= length b /\ compatible_sub b i len sub_rel))
...
val gsub_is_null (#n:nat) (#a:Type0) (#rrel #rel:srel a)
  (b:mbuffer #n a rrel rel) (i:index_t #n) (len:size_t #n) (sub_rel:srel a)
  :Lemma (requires ( i +  len <= length b /\ compatible_sub b i len sub_rel))
...
val len_gsub (#n:nat) (#a:Type0) (#rrel #rel:srel a)
  (b:mbuffer #n a rrel rel) (i:index_t #n) (len':index_t #n) (sub_rel:srel a)
  :Lemma (requires ( i +  len' <= length b /\ compatible_sub b i len' sub_rel))
...
val frameOf_gsub (#n:nat) (#a:Type0) (#rrel #rel:srel a)
  (b:mbuffer #n a rrel rel) (i:index_t #n) (len:size_t #n) (sub_rel:srel a)
  :Lemma (requires ( i +  len <= length b /\ compatible_sub b i len sub_rel))
         (ensures (frameOf (mgsub sub_rel b i len) == frameOf b))
  [SMTPat (frameOf (mgsub sub_rel b i len))]

val as_addr_gsub (#n:nat) (#a:Type0) (#rrel #rel:srel a)
  (b:mbuffer #n a rrel rel) (i:index_t #n) (len:size_t #n) (sub_rel:srel a)
  :Lemma (requires ( i +  len <= length b /\ compatible_sub b i len sub_rel))
         (ensures (as_addr (mgsub sub_rel b i len) == as_addr b))
         [SMTPat (as_addr (mgsub sub_rel b i len))]

val mgsub_inj (#n:nat) (#a:Type0) (#rrel #rel:srel a) (sub_rel1 sub_rel2:srel a)
  (b1 b2:mbuffer #n a rrel rel)
  (i1 i2:index_t #n)
  (len1 len2:index_t #n)
  :Lemma (requires ( i1 +  len1 <= length b1 /\ compatible_sub b1 i1 len1 sub_rel1 /\
                     i2 +  len2 <= length b2 /\ compatible_sub b2 i2 len2 sub_rel2 /\
...
val gsub_gsub (#n:nat) (#a:Type0) (#rrel #rel:srel a)
  (b:mbuffer #n a rrel rel)
  (i1:index_t #n) (len1:index_t #n) (sub_rel1:srel a)
  (i2: index_t #n) (len2: index_t #n) (sub_rel2:srel a)
  :Lemma (requires ( i1 +  len1 <= length b /\ compatible_sub b i1 len1 sub_rel1 /\
                     i2 +  len2 <=  len1 /\ compatible_sub (mgsub sub_rel1 b i1 len1) i2 len2 sub_rel2))
         (ensures  (compatible_sub b (i1 + i2) len2 sub_rel2 /\
                    mgsub sub_rel2 (mgsub sub_rel1 b i1 len1) i2 len2 == mgsub sub_rel2 b (i1 + i2) len2))
...
val gsub_zero_length (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel)
  :Lemma (compatible_sub b (UInt.zero n) (len b) rel /\ b == mgsub rel b (UInt.zero n) (len b))


/// The contents of a sub-buffer is the corresponding slice of the
/// contents of its enclosing buffer.

val as_seq_gsub (#n:nat) (#a:Type0) (#rrel #rel:srel a)
  (h:HS.mem) (b:mbuffer #n a rrel rel) (i:index_t #n) (len:size_t #n) (sub_rel:srel a)
  :Lemma (requires ( i +  len <= length b /\ compatible_sub b i len sub_rel))
         (ensures (as_seq h (mgsub sub_rel b i len) == Seq.slice (as_seq h b) ( i) ( i +  len)))
...
val loc_buffer (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) :GTot loc

val loc_buffer_null (#n:nat) (a:Type0) (rrel rel:srel a)
  :Lemma (loc_buffer (mnull #n #a #rrel #rel) == loc_none)
         [SMTPat (loc_buffer (mnull #n #a #rrel #rel))]
...
unfold let loc_addr_of_buffer (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) :GTot loc =
...
let loc_includes_gsub_buffer_r' (#n:nat) (#a:Type0) (#rrel #rel:srel a)
  (b:mbuffer #n a rrel rel) (i:index_t #n) (len:size_t #n) (sub_rel:srel a)
  :Lemma (requires (i + len <= (length b) /\ compatible_sub b i len sub_rel))
...
val loc_includes_gsub_buffer_l (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel)
  (i1:index_t #n) (len1:index_t #n) (sub_rel1:srel a)
  (i2:index_t #n) (len2:index_t #n) (sub_rel2:srel a)
  :Lemma (requires (i1 + len1 <= (length b) /\
                    i1 <= i2 /\ i2 + len2 <= i1 + len1 /\
...
val loc_includes_as_seq (#n:nat) (#a:Type0) (#rrel1 #rrel2 #rel1 #rel2:srel a)
  (h1 h2:HS.mem) (larger:mbuffer #n a rrel1 rel1) (smaller:mbuffer #n a rrel2 rel2)
...
val loc_includes_addresses_buffer (#n:nat) (#a:Type0) (#rrel #rel:srel a)
  (preserve_liveness:bool) (r:HS.rid) (s:Set.set nat) (p:mbuffer #n a rrel rel)
...
let loc_includes_addresses_buffer' (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel)
...
val loc_includes_region_buffer (#n:nat) (#a:Type0) (#rrel #rel:srel a)
  (preserve_liveness:bool) (s:Set.set HS.rid) (b:mbuffer #n a rrel rel)
...
let loc_includes_region_buffer' (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel)
...
val loc_disjoint_gsub_buffer (#n:nat) (#a:Type0) (#rrel:srel a) (#rel:srel a)
  (b:mbuffer #n a rrel rel)
  (i1:index_t #n) (len1:index_t #n) (sub_rel1:srel a)
  (i2:index_t #n) (len2:index_t #n) (sub_rel2:srel a)
  :Lemma (requires (i1 + len1 <= (length b) /\
...
val modifies_buffer_elim (#n:nat) (#a:Type0) (#rrel #rel:srel a)
  (b:mbuffer #n a rrel rel) (p:loc) (h h':HS.mem)
...
val address_liveness_insensitive_buffer (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel)
...
val region_liveness_insensitive_buffer (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel)
...
val live_loc_not_unused_in (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) (h:HS.mem)
  :Lemma (requires (live h b))
         (ensures  (loc_not_unused_in h `loc_includes` loc_addr_of_buffer b))
         [SMTPat (live h b)]

val unused_in_loc_unused_in (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) (h:HS.mem)
...
val modifies_inert_buffer_elim (#n:nat) (#a:Type0) (#rrel #rel:srel a)
  (b:mbuffer #n a rrel rel)
  (p:loc)
  (h h':HS.mem)
...
let disjoint (#n:nat) (#a1 #a2:Type0) (#rrel1 #rel1:srel a1) (#rrel2 #rel2:srel a2)
  (b1:mbuffer #n a1 rrel1 rel1) (b2:mbuffer #n a2 rrel2 rel2) :GTot Type0 =
  loc_disjoint (loc_buffer b1) (loc_buffer b2)

let includes (#n:nat) (#a1 #a2:Type0) (#rrel1 #rel1:srel a1) (#rrel2 #rel2:srel a2)
  (b1:mbuffer #n a1 rrel1 rel1) (b2:mbuffer #n a2 rrel2 rel2) :GTot Type0 =
  loc_includes (loc_buffer b1) (loc_buffer b2) /\
  (g_is_null b1 <==> g_is_null b2)

val disjoint_neq (#n:nat) (#a1 #a2:Type0) (#rrel1 #rel1:srel a1) (#rrel2 #rel2:srel a2)
  (b1:mbuffer #n a1 rrel1 rel1) (b2:mbuffer #n a2 rrel2 rel2)
  :Lemma (requires (disjoint b1 b2 /\  (len b1) > 0))
         (ensures (~(b1 === b2)))
...
val includes_live (#n:nat) (#a:Type0) (#rrel #rel1 #rel2:srel a)
  (h:HS.mem) (larger:mbuffer #n a rrel rel1) (smaller:mbuffer #n a rrel rel2)
...
val includes_frameOf_as_addr (#n:nat) (#a1 #a2:Type0) (#rrel1 #rel1:srel a1) (#rrel2 #rel2:srel a2)
  (larger:mbuffer #n a1 rrel1 rel1) (smaller:mbuffer #n a2 rrel2 rel2)
  :Lemma (requires (larger `includes` smaller))
...
type mpointer (#n:nat) (a:Type0) (rrel:srel a) (rel:srel a)  =
  b:mbuffer #n a rrel rel{length b == 1}

inline_for_extraction
type mpointer_or_null (#n:nat) (a:Type0) (rrel:srel a) (rel:srel a) =
  b:mbuffer #n a rrel rel{if g_is_null b then True else length b == 1}

unfold
let deref (#n:nat) (#a:Type0) (#rrel #rel:srel a) (h:HS.mem) (x:mpointer #n a rrel rel) =
  get h x 0
...
val is_null (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel)
...
val msub (#n:nat) (#a:Type0) (#rrel #rel:srel a) (sub_rel:srel a) (b:mbuffer #n a rrel rel)
  (i:index_t #n) (len:size_t #n)
  :HST.Stack (mbuffer #n a rrel sub_rel)
             (requires (fun h ->  i +  len <= length b /\ compatible_sub b i len sub_rel /\ live h b))
...
val moffset (#n:nat) (#a:Type0) (#rrel #rel:srel a) (sub_rel:srel a) (b:mbuffer #n a rrel rel)
  (i:index_t #n)
  :HST.Stack (mbuffer #n a rrel sub_rel)
             (requires (fun h ->  i <= length b /\ compatible_sub b i (UInt.sub (len b) i) sub_rel /\ live h b))
             (ensures  (fun h y h' -> h == h' /\ y == mgsub sub_rel b i (UInt.sub (len b) i)))
// goffset
...
val index (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) (i:index_t #n)
  :HST.Stack a (requires (fun h -> live h b /\  i < length b))
               (ensures  (fun h y h' -> h == h' /\ y == Seq.index (as_seq h b) ( i)))
...
val g_upd_seq (#n:nat) (#a:Type0) (#rrel #rel:srel a)
              (b:mbuffer #n a rrel rel) (s:Seq.lseq a (length b))
	      (h:HS.mem{live h b})
  :GTot HS.mem

val lemma_g_upd_with_same_seq (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) (h:HS.mem)
...
val g_upd_seq_as_seq (#n:nat) (#a:Type0) (#rrel #rel:srel a)
                     (b:mbuffer #n a rrel rel)
...
let g_upd (#n:nat) (#a:Type0) (#rrel #rel:srel a)
          (b:mbuffer #n a rrel rel)
          (i:nat{i < length b})
          (v:a)
          (h:HS.mem{live h b})
...
val upd'
  ...
  (i:index_t #n)
  (v:a)
  :HST.Stack unit (requires (fun h -> live h b /\  i < length b /\
                                   rel (as_seq h b) (Seq.upd (as_seq h b) ( i) v)))
                  (ensures  (fun h _ h' -> h' == g_upd b ( i) v h))
...
let upd
  ...
  = let h = HST.get () in
    upd' b i v;
    g_upd_seq_as_seq b (Seq.upd (as_seq h b) ( i) v) h

(* FIXME: Comment on `recall` *)

val recallable (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) :GTot Type0

val recallable_null (#n:nat) (#a:Type0) (#rrel #rel:srel a)
  :Lemma (recallable (mnull #n #a #rrel #rel)) [SMTPat (recallable (mnull #n #a #rrel #rel))]

val recallable_includes (#n:nat) (#a1 #a2:Type0) (#rrel1 #rel1:srel a1) (#rrel2 #rel2:srel a2)
  (larger:mbuffer #n a1 rrel1 rel1) (smaller:mbuffer #n a2 rrel2 rel2)
  :Lemma (requires (larger `includes` smaller))
...
val recall (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel)
 ...
 *)
unfold let stable_on (#n:nat) (#a:Type0) (p:spred a) (rel:srel a) =
...
val witnessed (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) (p:spred a) :Type0
 ...
 *)
val witness_p (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) (p:spred a)
  :HST.ST unit (requires (fun h0      -> p (as_seq #n h0 b) /\ stable_on #n p rel))
               (ensures  (fun h0 _ h1 -> h0 == h1 /\ witnessed #n b p))

val recall_p (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) (p:spred a)
  :HST.ST unit (requires (fun h0      -> (recallable #n b \/ live #n h0 b) /\ witnessed #n b p))
               (ensures  (fun h0 _ h1 -> h0 == h1 /\ live #n h0 b /\ p (as_seq #n h0 b)))
...
val freeable (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel) :GTot Type0

val free (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel)
...
val freeable_length (#n:nat) (#a:Type0) (#rrel #rel:srel a) (b:mbuffer #n a rrel rel)
  :Lemma (requires (freeable b)) (ensures (length b > 0))
         [SMTPat (freeable b)]

val freeable_disjoint (#n:nat) (#a1 #a2:Type0) (#rrel1 #rel1:srel a1) (#rrel2 #rel2:srel a2)
  (b1:mbuffer #n a1 rrel1 rel1) (b2:mbuffer #n a2 rrel2 rel2)
  :Lemma (requires (freeable b1 /\ length b2 > 0 /\ disjoint b1 b2))
         (ensures (frameOf b1 <> frameOf b2 \/ as_addr b1 <> as_addr b2))

let freeable_disjoint' (#n:nat) (#a1 #a2:Type0) (#rrel1 #rel1:srel a1) (#rrel2 #rel2:srel a2)
  (b1:mbuffer #n a1 rrel1 rel1) (b2:mbuffer #n a2 rrel2 rel2)
  :Lemma (requires (freeable b1 /\ length b2 > 0 /\ disjoint b1 b2))
...
unfold let lmbuffer (#n:nat) (a:Type0) (rrel rel:srel a) (len:nat)
  = b:mbuffer #n a rrel rel{length b == len /\ not (g_is_null b)}

unfold
let alloc_post_mem_common (#n:nat) (#a:Type0) (#rrel #rel:srel a)
  (b:mbuffer #n a rrel rel) (h0 h1:HS.mem) (s:Seq.seq a)
  = b `unused_in` h0 /\
    live h1 b /\
    Map.domain (HS.get_hmap h1) `Set.equal` Map.domain (HS.get_hmap h0) /\
    (HS.get_tip h1) == (HS.get_tip h0) /\
...
unfold let lmbuffer_or_null (#n:nat) (a:Type0) (rrel rel:srel a) (len:nat) (r:HS.rid)
  = b:mbuffer #n a rrel rel{(not (g_is_null b)) ==> (length b == len /\ frameOf b == r)}

unfold let alloc_partial_post_mem_common (#n:nat) (#a:Type0) (#rrel #rel:srel a)
  (b:mbuffer #n a rrel rel) (h0 h1:HS.mem) (s:Seq.seq a)
  = (g_is_null b /\ h0 == h1) \/
    ((not (g_is_null b)) /\ alloc_post_mem_common b h0 h1 s)


unfold let malloc_pre (#n:nat) (r:HS.rid) (len:size_t #n) = HST.is_eternal_region r /\  len > 0
 ...
 *)
val mgcmalloc (#n:nat) (#a:Type0) (#rrel:srel a)
  (r:HS.rid) (init:a) (len:size_t #n)
  :HST.ST (b:lmbuffer #n a rrel rrel (len){frameOf b == r /\ recallable b})
 ...
 *)
inline_for_extraction
let mgcmalloc_partial (#n:nat) (#a:Type0) (#rrel:srel a)
  (r:HS.rid) (init:a) (len:size_t #n)
  :HST.ST (b:lmbuffer_or_null a rrel rrel (len) r{recallable b})
          (requires (fun _       -> malloc_pre r len))
          (ensures  (fun h0 b h1 -> alloc_partial_post_mem_common b h0 h1 (Seq.create (len) init)))
 ...
 * See the Allocation comment above when changing the spec
 *)
val mmalloc (#n:nat) (#a:Type0) (#rrel:srel a)
  (r:HS.rid) (init:a) (len:size_t #n)
  :HST.ST (b:lmbuffer #n a rrel rrel (len){frameOf b == r /\ freeable b})
          (requires (fun _       -> malloc_pre r len))
          (ensures  (fun h0 b h1 -> alloc_post_mem_common b h0 h1 (Seq.create (len) init)))
 ...
 *)
inline_for_extraction
let mmalloc_partial (#n:nat) (#a:Type0) (#rrel:srel a)
  (r:HS.rid) (init:a) (len:size_t #n)
  :HST.ST (b:lmbuffer_or_null a rrel rrel (len) r{(not (g_is_null b)) ==> freeable b})
          (requires (fun _       -> malloc_pre r len))
          (ensures  (fun h0 b h1 -> alloc_partial_post_mem_common b h0 h1 (Seq.create (len) init)))
  = mmalloc r init len
...
unfold let alloca_pre (#n:nat) (len:size_t #n) =  len > 0

(*
 * See the Allocation comment above when changing the spec
 *)
val malloca (#n:nat) (#a:Type0) (#rrel:srel a)
  (init:a) (len:size_t #n)
  :HST.StackInline (lmbuffer #n a rrel rrel (len))
...
unfold let alloca_of_list_pre (#n:nat) (#a:Type0) (init:list a) =
 ...
 * See the Allocation comment above when changing the spec
 *)
val malloca_of_list (#n:nat) (#a:Type0) (#rrel:srel a) (init: list a)
  :HST.StackInline (lmbuffer #n a rrel rrel (normalize_term (List.Tot.length init)))
                   (requires (fun _      -> alloca_of_list_pre #n init))
                   (ensures (fun h0 b h1 -> alloc_post_mem_common b h0 h1 (Seq.seq_of_list init) /\
		                         frameOf b == HS.get_tip h0))

unfold let gcmalloc_of_list_pre (#n:nat) (#a:Type0) (r:HS.rid) (init:list a) =
 ...
 * See the Allocation comment above when changing the spec
 *)
val mgcmalloc_of_list (#n:nat) (#a:Type0) (#rrel:srel a) (r:HS.rid) (init:list a)
  :HST.ST (b:lmbuffer #n a rrel rrel (normalize_term (List.Tot.length init)){frameOf b == r /\ recallable b})
          (requires (fun _       -> gcmalloc_of_list_pre #n r init))
          (ensures  (fun h0 b h1 -> alloc_post_mem_common b h0 h1 (Seq.seq_of_list init)))
 ...
 *)
inline_for_extraction
let mgcmalloc_of_list_partial (#n:nat) (#a:Type0) (#rrel:srel a) (r:HS.rid) (init:list a)
  :HST.ST (b:lmbuffer_or_null a rrel rrel (normalize_term (List.Tot.length init)) r{recallable b})
          (requires (fun _       -> gcmalloc_of_list_pre #n r init))
          (ensures  (fun h0 b h1 -> alloc_partial_post_mem_common #n b h0 h1 (Seq.seq_of_list init)))
...
val blit (#n:nat) (#a:Type0) (#rrel1 #rrel2 #rel1 #rel2:srel a)
  (src:mbuffer #n a rrel1 rel1)
  (idx_src:index_t #n)
  (dst:mbuffer #n a rrel2 rel2)
  (idx_dst:index_t #n)
  (len:size_t #n)
  :HST.Stack unit (requires (fun h -> live h src /\ live h dst /\ disjoint src dst /\
                                     idx_src +  len <= length src /\
                                     idx_dst +  len <= length dst /\
				    rel2 (as_seq h dst)
				         (Seq.replace_subseq (as_seq h dst) ( idx_dst) ( idx_dst +  len)
					                     (Seq.slice (as_seq h src) ( idx_src) ( idx_src +  len)))))
                  (ensures (fun h _ h' -> modifies (loc_buffer dst) h h' /\
                                        live h' dst /\
                                        Seq.slice (as_seq h' dst) ( idx_dst) ( idx_dst +  len) ==
                                        Seq.slice (as_seq h src) ( idx_src) ( idx_src +  len) /\
                                        Seq.slice (as_seq h' dst) 0 ( idx_dst) ==
                                        Seq.slice (as_seq h dst) 0 ( idx_dst) /\
                                        Seq.slice (as_seq h' dst) ( idx_dst +  len) (length dst) ==
                                        Seq.slice (as_seq h dst) ( idx_dst +  len) (length dst)))

val fill (#n:nat) (#t:Type) (#rrel #rel: srel t)
...
: HST.Stack unit
  ...
  (ensures  (fun h0 _ h1 ->
    ...
    live h1 b /\
    Seq.slice (as_seq h1 b) 0 (len) == Seq.create (len) z /\
    Seq.slice (as_seq h1 b) (len) (length b) == Seq.slice (as_seq h0 b) (len) (length #n b)
  ))

val to_specific (#n:nat) (#a:Type0) (#rrel #rel: srel a) (b:mbuffer #n a rrel rel)
  : HST.StackInline (LMB.mbuffer a rrel rrel)
  (requires (fun h -> live h b /\ 0 < len b /\ len b <= UInt.max_int 32))
  (ensures (fun h0 r h1 -> 
                LMB.modifies (LMB.loc_buffer r) h0 h1 /\
                live h1 b /\ LMB.live h1 r))

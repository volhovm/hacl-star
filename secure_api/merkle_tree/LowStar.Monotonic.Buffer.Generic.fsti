...
let size2nat (#st:eqtype) (s:st): Tot nat = 0
val nat2size (#st:eqtype) (s:nat): Tot st
val size_add (#st:eqtype) (s1:st) (s2:st): Tot st
val size_at_least (#st:eqtype) (s1:st) (s2:st): Tot bool // s1 >= s2
val size_is_max (#st:eqtype) (s:st): Tot bool
val size_inc (#st:eqtype) (s:st): Tot st
val size_lte (#st:eqtype) (s1:st) (s2:st): Tot bool
 ...
 *)
val mbuffer (a:Type0) (st:eqtype) (rrel rel:srel a) :Tot Type0
...
val g_is_null (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) :GTot bool

val mnull (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) :Tot (b:mbuffer a st rrel rel {g_is_null b})

val null_unique (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) :Lemma (g_is_null b <==> b == mnull)

/// ``unused_in b h`` holds only if buffer ``b`` has not been allocated
/// yet.

val unused_in (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) (h:HS.mem) :GTot Type0
...
val live (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (h:HS.mem) (b:mbuffer a st rrel rel) :GTot Type0


/// The null pointer is always live.

val live_null (a:Type0) (st:eqtype) (rrel rel:srel a) (h:HS.mem) :Lemma (live h (mnull #a #st #rrel #rel))

let live_is_null (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (h:HS.mem) (b:mbuffer a st rrel rel)
  :Lemma (requires (g_is_null b == true))
         (ensures (live h b))
         [SMTPat (live h b)]
  = null_unique b;
    live_null a st rrel rel h

/// A live buffer has already been allocated.

val live_not_unused_in (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (h:HS.mem) (b:mbuffer a st rrel rel)
...
val lemma_live_equal_mem_domains (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) (h0 h1:HS.mem)
...
let live_not_unused_in' (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (h:HS.mem) (b:mbuffer a st rrel rel)
...
val frameOf (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) :Tot HS.rid
...
val as_addr (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) :GTot nat


/// A buffer is unused if, and only if, its address is unused.

val unused_in_equiv (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) (h:HS.mem)
  :Lemma (unused_in b h <==>
...
val live_region_frameOf (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (h:HS.mem) (b:mbuffer a st rrel rel)
...
val len (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) :Tot st
  
let length (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) :Tot nat =
  size2nat (len b)

let len_is_0 (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel): Tot bool = length b = 0  
val len_is_min (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel): Tot bool
val len_is_max (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel): Tot bool

val in_range (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) (i:st): Tot bool
val from_back (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) (i:st): Tot (r:st{in_range b r})
val in_length (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) (i:st) (len:st): Tot bool
  
val index_zero (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel): Tot st 
val size_zero (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel): Tot st
val size_one (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel): Tot st 

val same_size_width (#a:Type0) (#st:eqtype) (#rrel1 #rel1:srel a) (#rrel2 #rel2:srel a) (b1:mbuffer a st rrel1 rel1) (b2:mbuffer a st rrel2 rel2): Tot Type0

/// The null pointer has length 0.

val len_null (a:Type0) (st:eqtype) (rrel rel:srel a) :Lemma (len_is_0 (mnull #a #st #rrel #rel))

let length_null_1 (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel)
  :Lemma (requires (length b =!= 0)) (ensures (g_is_null b == false))
         [SMTPat (length b)]
  = len_null a st rrel rel;
    null_unique b

let length_null_2 (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel)
...
val as_seq (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (h:HS.mem) (b:mbuffer a st rrel rel) :GTot (Seq.seq a)


/// The contents of a buffer ``b`` has the same length as ``b`` itself.

val length_as_seq (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (h:HS.mem) (b:mbuffer a st rrel rel)
...
let get (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (h:HS.mem) (p:mbuffer a st rrel rel) (i:nat)
  :Ghost a (requires (in_range p (nat2size i))) (ensures (fun _ -> True))
  = Seq.index (as_seq h p) (nat2size i)
...
unfold let compatible_sub
  (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (b:mbuffer a st rrel rel) (i:st) (len:st{size2nat i + size2nat len <= length b}) (sub_rel:srel a)
  = (forall (s1 s2:Seq.seq a).{:pattern (rel s1 s2);
                               (sub_rel (Seq.slice s1 (size2nat i) (size2nat i + size2nat len))
			                     (Seq.slice s2 (size2nat i) (size2nat i + size2nat len)))}  //for any two sequences s1 and s2
      (Seq.length s1 == length b /\ Seq.length s2 == length b /\ rel s1 s2) ==>  //that have lengths same as b, and are related by the preorder rel
	    (sub_rel (Seq.slice s1 (size2nat i) (size2nat i + size2nat len))
		  (Seq.slice s2 (size2nat i) (size2nat i + size2nat len)))) /\  //their slices [i, i + len) should be related by the preorder sub_rel,
    (forall (s s2:Seq.seq a).{:pattern (sub_rel (Seq.slice s (size2nat i) (size2nat i + size2nat len)) s2);
                              (rel s (Seq.replace_subseq s (size2nat i) (size2nat i + size2nat len) s2))} //for any two sequences s and s2
            (Seq.length s == length b /\ Seq.length s2 == size2nat len /\  //such that s has length same as b and s2 has length len
              sub_rel (Seq.slice s (size2nat i) (size2nat i + size2nat len)) s2) ==>  //and the slice [i, i + len) of s is related to s2 by sub_rel,
  		        (rel s (Seq.replace_subseq s (size2nat i) (size2nat i + size2nat len) s2)))  //if we replace the slice [i, i + len) in s by s2, then s and the resulting buffer should be related by rel
...
val mgsub (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (sub_rel:srel a)
  (b:mbuffer a st rrel rel) (i:st) (s:st)
  :Ghost (mbuffer a st rrel sub_rel)
    (requires ((size2nat i + size2nat s) <= length b /\ compatible_sub b i s sub_rel))
	(ensures (fun _ -> True))
...
val live_gsub (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (h:HS.mem) (b:mbuffer a st rrel rel) (i:st) (len:st) (sub_rel:srel a)
  :Lemma (requires (in_length b i len /\ compatible_sub b i len sub_rel))
...
val gsub_is_null (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (b:mbuffer a st rrel rel) (i:st) (len:st) (sub_rel:srel a)
  :Lemma (requires (in_length b i len /\ compatible_sub b i len sub_rel))
...
val len_gsub (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (b:mbuffer a st rrel rel) (i:st) (len':st) (sub_rel:srel a)
  :Lemma (requires (size2nat i + size2nat len' <= length b /\ compatible_sub b i len' sub_rel))
...
val frameOf_gsub (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (b:mbuffer a st rrel rel) (i:st) (len:st) (sub_rel:srel a)
  :Lemma (requires (in_length b i len /\ compatible_sub b i len sub_rel))
         (ensures (frameOf (mgsub sub_rel b i len) == frameOf b))
  [SMTPat (frameOf (mgsub sub_rel b i len))]

val as_addr_gsub (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (b:mbuffer a st rrel rel) (i:st) (len:st) (sub_rel:srel a)
  :Lemma (requires (in_length b i len /\ compatible_sub b i len sub_rel))
         (ensures (as_addr (mgsub sub_rel b i len) == as_addr b))
         [SMTPat (as_addr (mgsub sub_rel b i len))]

val mgsub_inj (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (sub_rel1 sub_rel2:srel a)
  (b1 b2:mbuffer a st rrel rel)
  (i1 i2:st)
  (len1 len2:st)
  :Lemma (requires (size2nat i1 + size2nat len1 <= length b1 /\ compatible_sub b1 i1 len1 sub_rel1 /\
                    size2nat i2 + size2nat len2 <= length b2 /\ compatible_sub b2 i2 len2 sub_rel2 /\
...
val gsub_gsub (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (b:mbuffer a st rrel rel)
  (i1:st) (len1:st) (sub_rel1:srel a)
  (i2:st) (len2:st) (sub_rel2:srel a)
  :Lemma (requires (size2nat i1 + size2nat len1 <= length b /\ compatible_sub b i1 len1 sub_rel1 /\
                    (let q = (mgsub sub_rel1 b i1 len1) in
                     size2nat i2 + size2nat len1 <= length q /\
                     size2nat i2 + size2nat len2 <= size2nat len1 /\ compatible_sub q i2 len2 sub_rel2)))
         (ensures  (compatible_sub b (size_add i1 i2) len2 sub_rel2 /\
                    mgsub sub_rel2 (mgsub sub_rel1 b i1 len1) i2 len2 == mgsub sub_rel2 b (size_add i1 i2) len2))
...
val gsub_zero_length (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel)
  :Lemma (compatible_sub b (nat2size 0) (len b) rel /\ b == mgsub rel b (nat2size 0) (len b))


/// The contents of a sub-buffer is the corresponding slice of the
/// contents of its enclosing buffer.

val as_seq_gsub (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (h:HS.mem) (b:mbuffer a st rrel rel) (i:st) (len:st) (sub_rel:srel a)
  :Lemma (requires (in_length b i len /\ compatible_sub b i len sub_rel))
         (ensures (as_seq h (mgsub sub_rel b i len) == Seq.slice (as_seq h b) (size2nat i) (size2nat i + size2nat len)))
...
val loc_buffer (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) :GTot loc

val loc_buffer_null (a:Type0) (st:eqtype) (rrel rel:srel a)
  :Lemma (loc_buffer (mnull #a #st #rrel #rel) == loc_none)
         [SMTPat (loc_buffer (mnull #a #st #rrel #rel))]
...
unfold let loc_addr_of_buffer (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) :GTot loc =
...
val loc_includes_gsub_buffer_r
  ...
  (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (b:mbuffer a st rrel rel) (i:st) (len:st) (sub_rel:srel a)
: Lemma (requires (size2nat i + size2nat len <= (length b) /\
...
let loc_includes_gsub_buffer_r' (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (b:mbuffer a st rrel rel) (i:st) (len:st) (sub_rel:srel a)
  :Lemma (requires (size2nat i + size2nat len <= (length b) /\ compatible_sub b i len sub_rel))
...
val loc_includes_gsub_buffer_l (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel)
  (i1:st) (len1:st) (sub_rel1:srel a)
  (i2:st) (len2:st) (sub_rel2:srel a)
  :Lemma (requires (size2nat i1 + size2nat len1 <= (length b) /\
                    size2nat i1 <= size2nat i2 /\ size2nat i2 + size2nat len2 <= size2nat i1 + size2nat len1 /\
...
val loc_includes_as_seq (#a:Type0) (#st:eqtype) (#rrel1 #rrel2 #rel1 #rel2:srel a)
  (h1 h2:HS.mem) (larger:mbuffer a st rrel1 rel1) (smaller:mbuffer a st rrel2 rel2)
...
val loc_includes_addresses_buffer (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (preserve_liveness:bool) (r:HS.rid) (s:Set.set nat) (p:mbuffer a st rrel rel)
...
let loc_includes_addresses_buffer' (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel)
...
val loc_includes_region_buffer (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (preserve_liveness:bool) (s:Set.set HS.rid) (b:mbuffer a st rrel rel)
...
let loc_includes_region_buffer' (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel)
...
val loc_disjoint_gsub_buffer (#a:Type0) (#st:eqtype) (#rrel:srel a) (#rel:srel a)
  (b:mbuffer a st rrel rel)
  (i1:st) (len1:st) (sub_rel1:srel a)
  (i2:st) (len2:st) (sub_rel2:srel a)
  :Lemma (requires (size2nat i1 + size2nat len1 <= (length b) /\
                    size2nat i2 + size2nat len2 <= (length b) /\
		    compatible_sub b i1 len1 sub_rel1 /\ compatible_sub b i2 len2 sub_rel2 /\
		    (size2nat i1 + size2nat len1 <= size2nat i2 \/
                     size2nat i2 + size2nat len2 <= size2nat i1)))
...
val modifies_buffer_elim (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (b:mbuffer a st rrel rel) (p:loc) (h h':HS.mem)
...
val address_liveness_insensitive_buffer (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel)
...
val region_liveness_insensitive_buffer (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel)
...
val live_loc_not_unused_in (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) (h:HS.mem)
  :Lemma (requires (live h b))
         (ensures  (loc_not_unused_in h `loc_includes` loc_addr_of_buffer b))
         [SMTPat (live h b)]

val unused_in_loc_unused_in (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) (h:HS.mem)
...
val modifies_inert_buffer_elim (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (b:mbuffer a st rrel rel)
  (p:loc)
  (h h':HS.mem)
...
let disjoint (#a1 #a2:Type0) (#st1 #st2: eqtype) (#rrel1 #rel1:srel a1) (#rrel2 #rel2:srel a2)
  (b1:mbuffer a1 st1 rrel1 rel1) (b2:mbuffer a2 st2 rrel2 rel2) :GTot Type0 =
  loc_disjoint (loc_buffer b1) (loc_buffer b2)

let includes (#a1 #a2:Type0) (#st1 #st2: eqtype) (#rrel1 #rel1:srel a1) (#rrel2 #rel2:srel a2)
  (b1:mbuffer a1 st1 rrel1 rel1) (b2:mbuffer a2 st2 rrel2 rel2) :GTot Type0 =
  loc_includes (loc_buffer b1) (loc_buffer b2) /\
  (g_is_null b1 <==> g_is_null b2)

val disjoint_neq (#a1 #a2:Type0) (#st1 #st2: eqtype) (#rrel1 #rel1:srel a1) (#rrel2 #rel2:srel a2)
  (b1:mbuffer a1 st1 rrel1 rel1) (b2:mbuffer a2 st2 rrel2 rel2)
  :Lemma (requires (disjoint b1 b2 /\ size2nat (len b1) > 0))
         (ensures (~(b1 === b2)))
...
val includes_live (#a:Type0) (#st:eqtype) (#rrel #rel1 #rel2:srel a)
  (h:HS.mem) (larger:mbuffer a st rrel rel1) (smaller:mbuffer a st rrel rel2)
...
val includes_frameOf_as_addr (#a1 #a2:Type0) (#st1 #st2: eqtype) (#rrel1 #rel1:srel a1) (#rrel2 #rel2:srel a2)
  (larger:mbuffer a1 st1 rrel1 rel1) (smaller:mbuffer a2 st2 rrel2 rel2)
  :Lemma (requires (larger `includes` smaller))
...
type mpointer (a:Type0) (st:eqtype) (rrel:srel a) (rel:srel a)  =
  b:mbuffer a st rrel rel{length b == 1}

inline_for_extraction
type mpointer_or_null (a:Type0) (st:eqtype) (rrel:srel a) (rel:srel a) =
  b:mbuffer a st rrel rel{if g_is_null b then True else length b == 1}

unfold
let deref (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (h:HS.mem) (x:mpointer a st rrel rel) =
  get h x 0
...
val pointer_distinct_sel_disjoint
  (#a:Type0) (#st:eqtype) (#rrel1 #rrel2 #rel1 #rel2:srel a)
  (b1:mpointer a st rrel1 rel1)
  (b2:mpointer a st rrel2 rel2)
  (h:HS.mem)
...
val is_null (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel)
...
val msub (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (sub_rel:srel a) (b:mbuffer a st rrel rel)
  (i:st) (len:st)
  :HST.Stack (mbuffer a st rrel sub_rel)
             (requires (fun h -> in_length b i len /\ compatible_sub b i len sub_rel /\ live h b))
...
val moffset (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (sub_rel:srel a) (b:mbuffer a st rrel rel) (i:st)
 :HST.Stack (mbuffer a st rrel sub_rel)
            (requires (fun h -> size2nat i <= length b /\ compatible_sub b i (from_back b i) sub_rel /\ live h b))
            (ensures  (fun h y h' -> h == h' /\ y == mgsub sub_rel b i (from_back b i)))
// goffset
...
val index (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) (i:st)
  :HST.Stack a (requires (fun h -> live h b /\ size2nat i < length b))
               (ensures  (fun h y h' -> h == h' /\ y == Seq.index (as_seq h b) (size2nat i)))
...
val g_upd_seq (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
              (b:mbuffer a st rrel rel) (s:Seq.lseq a (length b))
	      (h:HS.mem{live h b})
  :GTot HS.mem

val lemma_g_upd_with_same_seq (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) (h:HS.mem)
...
val g_upd_seq_as_seq (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
                     (b:mbuffer a st rrel rel)
...
let g_upd (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
          (b:mbuffer a st rrel rel)
          (i:nat{i < length b})
          (v:a)
          (h:HS.mem{live h b})
...
val upd'
  ...
  (i:st)
  (v:a)
  :HST.Stack unit (requires (fun h -> live h b /\ size2nat i < length b /\
                                   rel (as_seq h b) (Seq.upd (as_seq h b) (size2nat i) v)))
                  (ensures  (fun h _ h' -> h' == g_upd b (size2nat i) v h))
...
let upd
  ...
  : HST.Stack unit (requires (fun h -> live h b /\ size2nat i < length b /\
                   ...
                   (ensures (fun h _ h' -> (not (g_is_null b)) /\
                                        modifies (loc_buffer b) h h' /\
                                        live h' b /\
                                        as_seq h' b == Seq.upd (as_seq h b) (size2nat i) v))
  = let h = HST.get () in
    upd' b i v;
    g_upd_seq_as_seq b (Seq.upd (as_seq h b) (size2nat i) v) h

(* FIXME: Comment on `recall` *)

val recallable (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) :GTot Type0

val recallable_null (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  :Lemma (recallable (mnull #a #st #rrel #rel)) [SMTPat (recallable (mnull #a #st #rrel #rel))]

val recallable_includes (#a1 #a2:Type0) (#st1 #st2: eqtype) (#rrel1 #rel1:srel a1) (#rrel2 #rel2:srel a2)
  (larger:mbuffer a1 st1 rrel1 rel1) (smaller:mbuffer a2 st2 rrel2 rel2)
  :Lemma (requires (larger `includes` smaller))
...
val recall (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel)
...
val witnessed (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) (p:spred a) :Type0
 ...
 *)
val witness_p (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) (p:spred a)
  :HST.ST unit (requires (fun h0      -> p (as_seq h0 b) /\ p `stable_on` rel))
               (ensures  (fun h0 _ h1 -> h0 == h1 /\ b `witnessed` p))

val recall_p (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) (p:spred a)
...
val freeable (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel) :GTot Type0

val free (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel)
...
val freeable_length (#a:Type0) (#st:eqtype) (#rrel #rel:srel a) (b:mbuffer a st rrel rel)
  :Lemma (requires (freeable b)) (ensures (length b > 0))
         [SMTPat (freeable b)]

val freeable_disjoint (#a1 #a2:Type0) (#st1 #st2: eqtype) (#rrel1 #rel1:srel a1) (#rrel2 #rel2:srel a2)
  (b1:mbuffer a1 st1 rrel1 rel1) (b2:mbuffer a2 st2 rrel2 rel2)
  :Lemma (requires (freeable b1 /\ length b2 > 0 /\ disjoint b1 b2))
         (ensures (frameOf b1 <> frameOf b2 \/ as_addr b1 <> as_addr b2))

let freeable_disjoint' (#a1 #a2:Type0) (#st1 #st2: eqtype) (#rrel1 #rel1:srel a1) (#rrel2 #rel2:srel a2)
  (b1:mbuffer a1 st1 rrel1 rel1) (b2:mbuffer a2 st2 rrel2 rel2)
  :Lemma (requires (freeable b1 /\ length b2 > 0 /\ disjoint b1 b2))
...
unfold let lmbuffer (a:Type0) (st:eqtype) (rrel rel:srel a) (len:nat)
  = b:mbuffer a st rrel rel{length b == len /\ not (g_is_null b)}

unfold
let alloc_post_mem_common (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (b:mbuffer a st rrel rel) (h0 h1:HS.mem) (s:Seq.seq a)
  = b `unused_in` h0 /\
    live h1 b /\
    Map.domain (HS.get_hmap h1) `Set.equal` Map.domain (HS.get_hmap h0) /\
    (HS.get_tip h1) == (HS.get_tip h0) /\
...
unfold let lmbuffer_or_null (a:Type0) (st:eqtype) (rrel rel:srel a) (len:nat) (r:HS.rid)
  = b:mbuffer a st rrel rel{(not (g_is_null b)) ==> (length b == len /\ frameOf b == r)}

unfold let alloc_partial_post_mem_common (#a:Type0) (#st:eqtype) (#rrel #rel:srel a)
  (b:mbuffer a st rrel rel) (h0 h1:HS.mem) (s:Seq.seq a)
  = (g_is_null b /\ h0 == h1) \/
    ((not (g_is_null b)) /\ alloc_post_mem_common b h0 h1 s)


unfold let malloc_pre (#st:eqtype) (r:HS.rid) (len:st) = HST.is_eternal_region r /\ size2nat len > 0
 ...
 *)
val mgcmalloc (#a:Type0) (#st:eqtype) (#rrel:srel a)
  (r:HS.rid) (init:a) (len:st)
  :HST.ST (b:lmbuffer a st rrel rrel (size2nat len){frameOf b == r /\ recallable b})
          (requires (fun _       -> malloc_pre r len))
          (ensures  (fun h0 b h1 -> alloc_post_mem_common b h0 h1 (Seq.create (size2nat len) init)))

(*
 * See the Allocation comment above when changing the spec
 *)
inline_for_extraction
let mgcmalloc_partial (#a:Type0) (#st:eqtype) (#rrel:srel a)
  (r:HS.rid) (init:a) (len:st)
  :HST.ST (b:lmbuffer_or_null a st rrel rrel (size2nat len) r{recallable b})
          (requires (fun _       -> malloc_pre r len))
          (ensures  (fun h0 b h1 -> alloc_partial_post_mem_common b h0 h1 (Seq.create (size2nat len) init)))
 ...
 * See the Allocation comment above when changing the spec
 *)
val mmalloc (#a:Type0) (#st:eqtype) (#rrel:srel a)
  (r:HS.rid) (init:a) (len:st)
  :HST.ST (b:lmbuffer a st rrel rrel (size2nat len){frameOf b == r /\ freeable b})
          (requires (fun _       -> malloc_pre r len))
          (ensures  (fun h0 b h1 -> alloc_post_mem_common b h0 h1 (Seq.create (size2nat len) init)))
 ...
 *)
inline_for_extraction
let mmalloc_partial (#a:Type0) (#st:eqtype) (#rrel:srel a)
  (r:HS.rid) (init:a) (len:st)
  :HST.ST (b:lmbuffer_or_null a st rrel rrel (size2nat len) r{(not (g_is_null b)) ==> freeable b})
          (requires (fun _       -> malloc_pre r len))
          (ensures  (fun h0 b h1 -> alloc_partial_post_mem_common b h0 h1 (Seq.create (size2nat len) init)))
  = mmalloc r init len
...
unfold let alloca_pre (#st:eqtype) (len:st) = size2nat len > 0

(*
 * See the Allocation comment above when changing the spec
 *)
val malloca (#a:Type0) (#st:eqtype) (#rrel:srel a)
  (init:a) (len:st)
  :HST.StackInline (lmbuffer a st rrel rrel (size2nat len))
 ...
 * See the Allocation comment above when changing the spec
 *)
val malloca_of_list (#a:Type0) (#st:eqtype) (#rrel:srel a) (init: list a)
  :HST.StackInline (lmbuffer a st rrel rrel (normalize_term (List.Tot.length init)))
 ...
 * See the Allocation comment above when changing the spec
 *)
val mgcmalloc_of_list (#a:Type0) (#st:eqtype) (#rrel:srel a) (r:HS.rid) (init:list a)
  :HST.ST (b:lmbuffer a st rrel rrel (normalize_term (List.Tot.length init)){frameOf b == r /\ recallable b})
 ...
 *)
inline_for_extraction
let mgcmalloc_of_list_partial (#a:Type0) (#st:eqtype) (#rrel:srel a) (r:HS.rid) (init:list a)
  :HST.ST (b:lmbuffer_or_null a st rrel rrel (normalize_term (List.Tot.length init)) r{recallable b})
          (requires (fun _       -> gcmalloc_of_list_pre r init))
...
val blit (#a:Type0) (#st:eqtype) (#rrel1 #rrel2 #rel1 #rel2:srel a)
  (src:mbuffer a st rrel1 rel1)
  (idx_src:st)
  (dst:mbuffer a st rrel2 rel2)
  (idx_dst:st)
  (len:st)
  :HST.Stack unit (requires (fun h -> live h src /\ live h dst /\ disjoint src dst /\
                                    size2nat idx_src + size2nat len <= length src /\
                                    size2nat idx_dst + size2nat len <= length dst /\
				    rel2 (as_seq h dst)
				         (Seq.replace_subseq (as_seq h dst) (size2nat idx_dst) (size2nat idx_dst + size2nat len)
					                     (Seq.slice (as_seq h src) (size2nat idx_src) (size2nat idx_src + size2nat len)))))
                  (ensures (fun h _ h' -> modifies (loc_buffer dst) h h' /\
                                        live h' dst /\
                                        Seq.slice (as_seq h' dst) (size2nat idx_dst) (size2nat idx_dst + size2nat len) ==
                                        Seq.slice (as_seq h src) (size2nat idx_src) (size2nat idx_src + size2nat len) /\
                                        Seq.slice (as_seq h' dst) 0 (size2nat idx_dst) ==
                                        Seq.slice (as_seq h dst) 0 (size2nat idx_dst) /\
                                        Seq.slice (as_seq h' dst) (size2nat idx_dst + size2nat len) (length dst) ==
                                        Seq.slice (as_seq h dst) (size2nat idx_dst + size2nat len) (length dst)))

val fill (#a:Type) (#st:eqtype) (#rrel #rel: srel a)
  (b:mbuffer a st rrel rel)
  (z:a)
  (len:st)
: HST.Stack unit
  (requires (fun h ->
    live h b /\
    size2nat len <= length b /\
    rel (as_seq h b) (Seq.replace_subseq (as_seq h b) 0 (size2nat len) (Seq.create (size2nat len) z))
  ))
  (ensures  (fun h0 _ h1 ->
    modifies (loc_buffer b) h0 h1 /\
    live h1 b /\
    Seq.slice (as_seq h1 b) 0 (size2nat len) == Seq.create (size2nat len) z /\
    Seq.slice (as_seq h1 b) (size2nat len) (length b) == Seq.slice (as_seq h0 b) (size2nat len) (length b)
  ))

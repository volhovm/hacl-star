...
let params_barr_mult = I64.int_to_t (normalize_term 511)
let params_barr_div = UI32.uint_to_t (normalize_term 32)
let params_qinv = I64.int_to_t (normalize_term 4034936831)
let params_q_log = size (normalize_term 24) // TODO: this can be computed
let params_r2_invn = I64.int_to_t (normalize_term 237839)
let params_s_bits = size (normalize_term 9)

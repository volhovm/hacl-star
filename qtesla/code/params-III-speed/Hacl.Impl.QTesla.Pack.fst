...
let encode_sk sk s e seeds =
	...
	sk.(j+.size 4) <- elem_to_uint8 (((si3 >>^ 5ul) &^ 0x0fl) |^ (si3 <<^ 4ul));
	sk.(j+.size 5) <- elem_to_uint8 (((si4 >>^ 4ul) &^ 0x1fl) |^ (si3 <<^ 5ul));
	sk.(j+.size 6) <- elem_to_uint8 (((si5 >>^ 3ul) &^ 0x3fl) |^ (si3 <<^ 6ul));
	sk.(j+.size 7) <- elem_to_uint8 (((si6 >>^ 2ul) &^ 0x7fl) |^ (si3 <<^ 7ul));
	...
	let j = jBuf.(size 0) in
        ...
        let ei0 = s.(i+.size 0) in    let ei1 = s.(i+.size 1) in
	let ei2 = s.(i+.size 2) in    let ei3 = s.(i+.size 3) in
	let ei4 = s.(i+.size 4) in    let ei5 = s.(i+.size 5) in
	let ei6 = s.(i+.size 6) in    let ei7 = s.(i+.size 7) in
	...
	sk.(j+.size 4) <- elem_to_uint8 (((ei3 >>^ 5ul) &^ 0x0fl) |^ (ei3 <<^ 4ul));
	sk.(j+.size 5) <- elem_to_uint8 (((ei4 >>^ 4ul) &^ 0x1fl) |^ (ei3 <<^ 5ul));
	sk.(j+.size 6) <- elem_to_uint8 (((ei5 >>^ 3ul) &^ 0x3fl) |^ (ei3 <<^ 6ul));
	sk.(j+.size 7) <- elem_to_uint8 (((ei6 >>^ 2ul) &^ 0x7fl) |^ (ei3 <<^ 7ul));
...
let decode_sig c z smlen sm =
	...
	let ptj10 = pt (j+.size 10) in
        ...
        z.(i+.size  7) <- i2e I32.( u2i UI32.( ptj5 >>^ 16ul ) |^ (u2i UI32.(ptj6 <<^ 26ul)) >>^ 10ul );

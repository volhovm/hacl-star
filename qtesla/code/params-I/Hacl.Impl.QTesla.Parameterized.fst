...
let decode_sk seeds s e sk =
	...
	s.(i+.size 1) <- I16.(uint8_to_int16 UI8.(skj2 >>^ 4ul) |^ int32_to_int16 I32.(((uint8_to_int32 skj3) <<^ 26ul) >>^ 22ul));
	s.(i+.size 1) <- I16.(uint8_to_int16 UI8.(skj3 >>^ 6ul) |^ int8_to_int16 I8.((uint8_to_int8 skj4) <<^ 2ul));
	...
	e.(i+.size 1) <- I16.(uint8_to_int16 UI8.(skj2 >>^ 4ul) |^ int32_to_int16 I32.(((uint8_to_int32 skj3) <<^ 26ul) >>^ 22ul));
	e.(i+.size 1) <- I16.(uint8_to_int16 UI8.(skj3 >>^ 6ul) |^ int8_to_int16 I8.((uint8_to_int8 skj4) <<^ 2ul));
...
let encode_pk pk t seedA =
    ...
    (fun _ -> (jBuf.(size 0)) <. params_n *. params_q_log /. size 32)
    (fun _ ->
        let i = iBuf.(size 0) in
	let j = jBuf.(size 0) in
...
let decode_pk pk seedA pk_in =
	...
	let ppi7 = UI32.(  ((pt (j+.size  5)) >>^  1ul)  ) in pk.(i+.size  7) <- u2i ppi7;
...
let encode_sig_ptSet buf i value = 
    uint_to_bytes_le (sub buf (i *. size UI32.n /. size 8) (size UI32.n /. size 8)) value
...
let encode_sig sm c z =
	...
	pt (i+.size  3) UI32.( (((t_ (j +.size  4)) >>^ 12ul) &^ ((1ul <<^  9ul) -^ 1ul)) |^ (((t_ (j+.size  5)) &^ ((1ul <<^ 21ul) -^ 1ul)) <<^  9ul) |^ ((t_ (j+.size  3)) <<^ 30ul) );
	pt (i+.size  4) UI32.( (((t_ (j +.size  6)) >>^  2ul) &^ ((1ul <<^ 19ul) -^ 1ul)) |^ ((t_ (j+.size  7)) <<^ 19ul) );
	pt (i+.size  5) UI32.( (((t_ (j +.size  7)) >>^ 13ul) &^ ((1ul <<^  8ul) -^ 1ul)) |^ (((t_ (j+.size  8)) &^ ((1ul <<^ 21ul) -^ 1ul)) <<^  8ul) |^ ((t_ (j+.size  3)) <<^ 29ul) );
	pt (i+.size  6) UI32.( (((t_ (j +.size  9)) >>^  3ul) &^ ((1ul <<^ 18ul) -^ 1ul)) |^ ((t_ (j+.size 10)) <<^ 18ul) );
	pt (i+.size  7) UI32.( (((t_ (j +.size 10)) >>^ 14ul) &^ ((1ul <<^  7ul) -^ 1ul)) |^ (((t_ (j+.size 11)) &^ ((1ul <<^ 21ul) -^ 1ul)) <<^  7ul) |^ ((t_ (j+.size  3)) <<^ 28ul) );
	pt (i+.size  8) UI32.( (((t_ (j +.size 12)) >>^  4ul) &^ ((1ul <<^ 17ul) -^ 1ul)) |^ ((t_ (j+.size 13)) <<^ 17ul) );
	pt (i+.size  9) UI32.( (((t_ (j +.size 13)) >>^ 15ul) &^ ((1ul <<^  6ul) -^ 1ul)) |^ (((t_ (j+.size 14)) &^ ((1ul <<^ 21ul) -^ 1ul)) <<^  6ul) |^ ((t_ (j+.size  3)) <<^ 27ul) );
	pt (i+.size 10) UI32.( (((t_ (j +.size 15)) >>^  5ul) &^ ((1ul <<^ 16ul) -^ 1ul)) |^ ((t_ (j+.size 16)) <<^ 16ul) );
	pt (i+.size 11) UI32.( (((t_ (j +.size 16)) >>^ 16ul) &^ ((1ul <<^  5ul) -^ 1ul)) |^ (((t_ (j+.size 17)) &^ ((1ul <<^ 21ul) -^ 1ul)) <<^  5ul) |^ ((t_ (j+.size  3)) <<^ 26ul) );
	pt (i+.size 12) UI32.( (((t_ (j +.size 18)) >>^  6ul) &^ ((1ul <<^ 15ul) -^ 1ul)) |^ ((t_ (j+.size 19)) <<^ 15ul) );
	pt (i+.size 13) UI32.( (((t_ (j +.size 19)) >>^ 17ul) &^ ((1ul <<^  4ul) -^ 1ul)) |^ (((t_ (j+.size 20)) &^ ((1ul <<^ 21ul) -^ 1ul)) <<^  4ul) |^ ((t_ (j+.size  3)) <<^ 25ul) );
	pt (i+.size 14) UI32.( (((t_ (j +.size 21)) >>^  7ul) &^ ((1ul <<^ 14ul) -^ 1ul)) |^ ((t_ (j+.size 22)) <<^ 14ul) );
	pt (i+.size 15) UI32.( (((t_ (j +.size 22)) >>^ 18ul) &^ ((1ul <<^  3ul) -^ 1ul)) |^ (((t_ (j+.size 23)) &^ ((1ul <<^ 21ul) -^ 1ul)) <<^  3ul) |^ ((t_ (j+.size  3)) <<^ 24ul) );
	pt (i+.size 16) UI32.( (((t_ (j +.size 24)) >>^  8ul) &^ ((1ul <<^ 13ul) -^ 1ul)) |^ ((t_ (j+.size 25)) <<^ 13ul) );
	pt (i+.size 17) UI32.( (((t_ (j +.size 25)) >>^ 19ul) &^ ((1ul <<^  2ul) -^ 1ul)) |^ (((t_ (j+.size 26)) &^ ((1ul <<^ 21ul) -^ 1ul)) <<^  2ul) |^ ((t_ (j+.size  3)) <<^ 23ul) );
	pt (i+.size 18) UI32.( (((t_ (j +.size 27)) >>^  9ul) &^ ((1ul <<^ 12ul) -^ 1ul)) |^ ((t_ (j+.size 28)) <<^ 12ul) );
	pt (i+.size 19) UI32.( (((t_ (j +.size 28)) >>^ 20ul) &^ ((1ul <<^  1ul) -^ 1ul)) |^ (((t_ (j+.size 29)) &^ ((1ul <<^ 21ul) -^ 1ul)) <<^  1ul) |^ ((t_ (j+.size  3)) <<^ 22ul) );

...
let params_barr_mult = I64.int_to_t (normalize_term 15)
let params_barr_div = UI32.uint_to_t (normalize_term 34)
let params_qinv = I64.int_to_t (normalize_term 861290495)
let params_q_log = size (normalize_term 31) // TODO: this can be computed
let params_r2_invn = I64.int_to_t (normalize_term 851423148)

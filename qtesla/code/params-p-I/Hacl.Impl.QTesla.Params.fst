...
let params_barr_mult = I64.int_to_t (normalize_term 1)
let params_barr_div = UI32.uint_to_t (normalize_term 29)
let params_qinv = I64.int_to_t (normalize_term 3421990911)
let params_q_log = size (normalize_term 29) // TODO: this can be computed
let params_r2_invn = I64.int_to_t (normalize_term 472064468)

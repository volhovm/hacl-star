...
let decode_sig c z smlen sm =
	...
	let ptj10 = pt (j+.size 10) in
        ...
        z.(i+.size  1) <- i2e I32.( u2i UI32.( ptj0 >>^ 22ul ) |^ UI32.(u2i (ptj1 <<^ 20ul)) >>^ 10ul );
        z.(i+.size  2) <- i2e I32.( u2i UI32.( ptj1 >>^ 12ul ) |^ UI32.(u2i (ptj2 <<^ 30ul)) >>^ 10ul );
        z.(i+.size  3) <- i2e I32.( u2i UI32.( ptj2 <<^  8ul ) >>^ 10ul );
        z.(i+.size  4) <- i2e I32.( u2i UI32.( ptj2 >>^ 24ul ) |^ UI32.(u2i (ptj3 <<^ 18ul)) >>^ 10ul );
        z.(i+.size  5) <- i2e I32.( u2i UI32.( ptj3 >>^ 14ul ) |^ UI32.(u2i (ptj4 <<^ 28ul)) >>^ 10ul );
        z.(i+.size  6) <- i2e I32.( u2i UI32.( ptj4 <<^  6ul ) >>^ 10ul );
        z.(i+.size  7) <- i2e I32.( u2i UI32.( ptj4 >>^ 26ul ) |^ UI32.(u2i (ptj5 <<^ 16ul)) >>^ 10ul );
        z.(i+.size  8) <- i2e I32.( u2i UI32.( ptj5 >>^ 16ul ) |^ UI32.(u2i (ptj6 <<^ 26ul)) >>^ 10ul );
        z.(i+.size  9) <- i2e I32.( u2i UI32.( ptj6 <<^  4ul ) >>^ 10ul );
        z.(i+.size 10) <- i2e I32.( u2i UI32.( ptj6 >>^ 28ul ) |^ UI32.(u2i (ptj7 <<^ 14ul)) >>^ 10ul );
        z.(i+.size 11) <- i2e I32.( u2i UI32.( ptj7 >>^ 18ul ) |^ UI32.(u2i (ptj8 <<^ 24ul)) >>^ 10ul );
        z.(i+.size 12) <- i2e I32.( u2i UI32.( ptj8 <<^  2ul ) >>^ 10ul );
        z.(i+.size 13) <- i2e I32.( u2i UI32.( ptj8 >>^ 30ul ) |^ UI32.(u2i (ptj9 <<^ 12ul)) >>^ 10ul );
        z.(i+.size 14) <- i2e I32.( u2i UI32.( ptj9 >>^ 20ul ) |^ UI32.(u2i (ptj10<<^ 22ul)) >>^ 10ul );
        z.(i+.size 15) <- i2e I32.( u2i UI32.( ptj10 >>^ 10ul ) >>^ 10ul );
